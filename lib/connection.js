...
Connection.prototype.writeColumns = function(columns) {
  ...
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.CLIENT_DEPRECATE_EOF)) {
    connection.writeOk();
  } else {
    connection.writeEof();
  }
...
Connection.prototype.writeTextResult = function(rows, columns) {
  var connection = this;
/*
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.LONG_PASSWORD)) {
    console.log('client has LONG_PASSWORD set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.FOUND_ROWS)) {
    console.log('client has FOUND_ROWS set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.LONG_FLAG)) {
    console.log('client has LONG_FLAG set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.CONNECT_WITH_DB)) {
    console.log('client has CONNECT_WITH_DB set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.NO_SCHEMA)) {
    console.log('client has NO_SCHEMA set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.COMPRESS)) {
    console.log('client has COMPRESS set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.ODBC)) {
    console.log('client has ODBC set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.LOCAL_FILES)) {
    console.log('client has LOCAL_FILES set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.IGNORE_SPACE)) {
    console.log('client has IGNORE_SPACE set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.PROTOCOL_41)) {
    console.log('client has PROTOCOL_41 set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.INTERACTIVE)) {
    console.log('client has INTERACTIVE set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.SSL)) {
    console.log('client has SSL set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.IGNORE_SIGPIPE)) {
    console.log('client has IGNORE_SIGPIPE set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.TRANSACTIONS)) {
    console.log('client has TRANSACTIONS set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.RESERVED)) {
    console.log('client has RESERVED set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.SECURE_CONNECTION)) {
    console.log('client has SECURE_CONNECTION set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.MULTI_STATEMENTS)) {
    console.log('client has MULTI_STATEMENTS set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.MULTI_RESULTS)) {
    console.log('client has MULTI_RESULTS set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.PS_MULTI_RESULTS)) {
    console.log('client has PS_MULTI_RESULTS set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.PLUGIN_AUTH)) {
    console.log('client has PLUGIN_AUTH set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.CLIENT_DEPRECATE_EOF)) {
    console.log('client has CLIENT_DEPRECATE_EOF set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.SSL_VERIFY_SERVER_CERT)) {
    console.log('client has SSL_VERIFY_SERVER_CERT set');
  }
  if (0 !== (connection.clientHelloReply.clientFlags & ClientConstants.REMEMBER_OPTIONS)) {
    console.log('client has REMEMBER_OPTIONS set');
  }
*/
