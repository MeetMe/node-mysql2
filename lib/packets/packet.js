...
Packet.prototype.readLengthCodedNumberExt = function(tag, bigNumberStrings) {
   ...
   console.trace();
   throw "Should not reach here: " + tag;
};
...
Packet.lengthCodedStringLengthInBytes = function(s) {
  var lengthInBytes = Buffer.byteLength(s, 'utf8');
  return (lengthInBytes + this.lengthCodedNumberLength(lengthInBytes));
};
